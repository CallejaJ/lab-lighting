  Sesión 4 · Laboratorio Lightning con Polar · UMA 2026     /\* =============================================================== DESIGN TOKENS · Swiss Modern palette · shared with slide deck =============================================================== \*/ :root { --accent: #2f6aff; --accent-ln: #ffd166; --accent-btc: #f7931a; --success: #2ecc71; --danger: #e74c3c; --ink: #0a0a0a; --ink-soft: #2b2b2b; --muted: #8a8a8a; --bg: #fafaf7; --bg-panel: #f2f1ec; --bg-code: #0a0a0a; --border: rgba(10, 10, 10, 0.14); --font-display: 'Archivo', system-ui, sans-serif; --font-body: 'Nunito', system-ui, sans-serif; --font-mono: 'JetBrains Mono', ui-monospace, monospace; } \* { margin: 0; padding: 0; box-sizing: border-box; } html { scroll-behavior: smooth; } body { font-family: var(--font-body); color: var(--ink-soft); background: var(--bg); line-height: 1.6; font-size: 16px; padding: clamp(1.5rem, 4vw, 3rem) clamp(1rem, 4vw, 3rem) 4rem; max-width: 1040px; margin: 0 auto; } /\* =========== Typography =========== \*/ h1 { font-family: var(--font-display); font-weight: 900; font-size: clamp(2.2rem, 4.5vw, 3.6rem); line-height: 1.05; letter-spacing: -0.025em; color: var(--ink); margin-bottom: 0.75rem; } h1 .accent { color: var(--accent); } h2 { font-family: var(--font-display); font-weight: 800; font-size: clamp(1.4rem, 2.6vw, 2rem); line-height: 1.2; letter-spacing: -0.01em; color: var(--ink); margin-top: 0.75rem; margin-bottom: 0.85rem; } h3 { font-family: var(--font-display); font-weight: 700; font-size: clamp(1rem, 1.4vw, 1.15rem); color: var(--ink); margin-top: 1.5rem; margin-bottom: 0.6rem; letter-spacing: 0; } p { margin-bottom: 0.95rem; } ul, ol { margin: 0.5rem 0 1rem 1.5rem; } li { margin-bottom: 0.35rem; } strong, b { color: var(--ink); font-weight: 700; } em { font-style: italic; color: var(--ink); } /\* =========== Inline code =========== \*/ code { font-family: var(--font-mono); font-size: 0.86em; background: var(--bg-panel); padding: 0.08em 0.38em; border-radius: 2px; color: var(--accent); border: 1px solid var(--border); } /\* =========== Links =========== \*/ a { color: var(--accent); text-decoration: underline; text-underline-offset: 3px; text-decoration-thickness: 1px; } a:hover { color: var(--ink); text-decoration-thickness: 2px; } /\* =============================================================== DOCUMENT HEADER =============================================================== \*/ .doc-header { border-bottom: 4px solid var(--ink); padding-bottom: 1.75rem; margin-bottom: 2.5rem; } .breadcrumb { font-family: var(--font-display); font-weight: 800; font-size: 0.78rem; text-transform: uppercase; letter-spacing: 0.22em; color: var(--accent); margin-bottom: 1.25rem; display: flex; align-items: center; gap: 0.6rem; } .breadcrumb::before { content: ''; display: inline-block; width: 0.55rem; height: 0.55rem; background: var(--accent); } .lead { font-size: clamp(1.05rem, 1.4vw, 1.2rem); color: var(--ink-soft); line-height: 1.5; margin: 1rem 0 1.5rem; max-width: 72ch; } .meta { font-family: var(--font-mono); font-size: 0.82rem; color: var(--muted); display: flex; flex-wrap: wrap; gap: 0.6rem 2rem; } .meta .item { display: inline-flex; align-items: center; gap: 0.4rem; } .meta strong { color: var(--ink); font-family: var(--font-mono); font-weight: 700; } /\* =============================================================== SECTION HEADINGS + BLOCK METADATA =============================================================== \*/ section { margin-top: 2.5rem; } section.bloque { padding-top: 2.5rem; border-top: 1px solid var(--border); margin-top: 2.5rem; } .bloque-head { display: flex; align-items: center; gap: 0.85rem; flex-wrap: wrap; margin-bottom: 0.3rem; } .bloque-num { font-family: var(--font-mono); font-weight: 700; font-size: 0.75rem; letter-spacing: 0.1em; text-transform: uppercase; background: rgba(47, 106, 255, 0.10); color: var(--accent); padding: 0.25rem 0.55rem; border-radius: 2px; } .bloque-num.deliverable { background: var(--accent-btc); color: white; } .bloque-time { font-family: var(--font-mono); font-size: 0.78rem; color: var(--muted); } .bloque-time::before { content: '⏱ '; } .concepts { font-family: var(--font-display); font-size: 0.78rem; font-weight: 600; letter-spacing: 0.04em; color: var(--muted); text-transform: uppercase; margin-bottom: 1.1rem; padding-left: 1rem; border-left: 2px solid var(--accent); } /\* =============================================================== INFO BOXES (check · warn · deliverable) =============================================================== \*/ .box { border: 1px solid var(--border); background: var(--bg-panel); padding: 1.1rem 1.35rem; margin: 1.5rem 0; border-left: 4px solid var(--accent); } .box.check { border-left-color: var(--success); background: rgba(46, 204, 113, 0.06); } .box.warn { border-left-color: var(--accent-ln); background: rgba(255, 209, 102, 0.08); } .box.deliverable { border: 2px solid var(--accent-btc); border-left-width: 6px; background: rgba(247, 147, 26, 0.05); padding: 1.4rem 1.6rem; } .box .tag { display: inline-block; font-family: var(--font-display); font-weight: 800; font-size: 0.68rem; letter-spacing: 0.18em; text-transform: uppercase; padding: 0.14rem 0.5rem; background: var(--accent); color: white; border-radius: 2px; margin-bottom: 0.6rem; } .box.check .tag { background: var(--success); } .box.warn .tag { background: var(--accent-ln); color: var(--ink); } .box.deliverable .tag { background: var(--accent-btc); } .box p:last-child, .box ul:last-child, .box ol:last-child { margin-bottom: 0; } /\* =============================================================== CODE BLOCKS (dark) =============================================================== \*/ pre { background: var(--bg-code); color: #e6ecf7; padding: 0.95rem 1.2rem; border-radius: 3px; overflow-x: auto; margin: 0.7rem 0 1rem; font-family: var(--font-mono); font-size: 0.84rem; line-height: 1.6; } pre code { background: transparent; padding: 0; border: none; color: inherit; font-size: inherit; } pre .comment { color: #6c7280; font-style: italic; } pre .prompt { color: #58c7ff; user-select: none; font-weight: 700; } pre .flag { color: #ffd166; } pre .str { color: #7ee787; } pre .kw { color: #ff7b72; } /\* =============================================================== NUMBERED STEPS =============================================================== \*/ ol.steps { list-style: none; counter-reset: step; margin-left: 0; padding-left: 0; } ol.steps > li { counter-increment: step; padding-left: 2.6rem; margin-bottom: 1.4rem; position: relative; } ol.steps > li::before { content: counter(step); position: absolute; left: 0; top: -0.1rem; width: 1.85rem; height: 1.85rem; background: var(--ink); color: white; font-family: var(--font-display); font-weight: 800; font-size: 0.88rem; display: flex; align-items: center; justify-content: center; border-radius: 50%; } /\* =============================================================== PLANNING TABLE =============================================================== \*/ .planning { width: 100%; border-collapse: collapse; margin: 1rem 0; font-size: 0.92rem; border: 1px solid var(--border); } .planning th, .planning td { padding: 0.7rem 1rem; border-bottom: 1px solid var(--border); text-align: left; vertical-align: top; } .planning tr:last-child td { border-bottom: none; } .planning th { background: var(--ink); color: white; font-family: var(--font-display); font-weight: 800; text-transform: uppercase; letter-spacing: 0.09em; font-size: 0.72rem; } .planning td.time { font-family: var(--font-mono); color: var(--accent); white-space: nowrap; font-weight: 700; } .planning td.name strong { font-family: var(--font-display); } .planning td.concepts-td { font-family: var(--font-body); color: var(--muted); font-size: 0.85rem; } /\* =============================================================== DELIVERABLE QUESTIONS =============================================================== \*/ ol.questions { counter-reset: question; list-style: none; margin-left: 0; padding-left: 0; } ol.questions > li { counter-increment: question; padding: 0.7rem 0 0.7rem 3.2rem; margin-bottom: 0.4rem; position: relative; border-bottom: 1px dashed var(--border); } ol.questions > li:last-child { border-bottom: none; } ol.questions > li::before { content: 'Q' counter(question, decimal-leading-zero); position: absolute; left: 0; top: 0.75rem; font-family: var(--font-mono); font-weight: 700; color: var(--accent-btc); font-size: 0.86rem; letter-spacing: 0.05em; } /\* =============================================================== EVALUATION GRID =============================================================== \*/ .eval-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 0.75rem; margin: 1rem 0; } .eval-item { border: 1px solid var(--border); padding: 0.9rem 1rem; background: var(--bg); } .eval-item .pct { font-family: var(--font-display); font-weight: 900; font-size: 1.8rem; color: var(--accent-btc); line-height: 1; } .eval-item .lbl { font-family: var(--font-display); font-weight: 700; font-size: 0.82rem; text-transform: uppercase; letter-spacing: 0.08em; color: var(--ink); margin-top: 0.4rem; } .eval-item .desc { font-size: 0.82rem; color: var(--muted); margin-top: 0.35rem; } /\* =============================================================== FOOTER =============================================================== \*/ .doc-footer { margin-top: 4rem; padding-top: 2rem; border-top: 4px solid var(--ink); font-size: 0.85rem; color: var(--muted); display: flex; justify-content: space-between; flex-wrap: wrap; gap: 1rem; font-family: var(--font-display); letter-spacing: 0.04em; } .doc-footer strong { color: var(--ink); } /\* =============================================================== PRINT & RESPONSIVE =============================================================== \*/ @media print { body { padding: 1.5cm; max-width: 100%; font-size: 11pt; } section.bloque { break-inside: avoid-page; page-break-inside: avoid; } .box { break-inside: avoid; } pre { break-inside: avoid; font-size: 9pt; } .doc-footer { position: fixed; bottom: 0.8cm; left: 1.5cm; right: 1.5cm; } a { color: var(--ink); text-decoration: none; } a\[href\]:after { content: " (" attr(href) ")"; font-size: 0.75em; color: var(--muted); } } @media (max-width: 640px) { body { padding: 1rem; font-size: 15px; } h1 { font-size: 2rem; } .meta { flex-direction: column; gap: 0.3rem; } ol.steps > li { padding-left: 2.3rem; } ol.questions > li { padding-left: 2.6rem; } pre { font-size: 0.75rem; padding: 0.75rem 0.9rem; } }
...
**Curso de Extensión Universitaria en Tecnologías Blockchain** · UMA · 2026 Módulo 05 · Sesión 4 · Manuel Montenegro